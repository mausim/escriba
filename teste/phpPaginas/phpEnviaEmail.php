<?php
 ...
 require '/teste/PHPMailer-master/src/Exception.php';
 require '/teste/PHPMailer-master/src/PHPMailer.php';
 require '/teste/PHPMailer-master/src/SMTP.php';
 ...
 $mail->Password = 'C@bumba2010'; // Senha da sua conta de email
 // DADOS DO REMETENTE
 ...
 if ($enviado) {
   ...
   echo "Não foi possível enviar o e-mail para ".$destinatarioVez;
